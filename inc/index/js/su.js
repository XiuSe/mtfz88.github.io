(function(a) {
    a.fn.wpSuperSnow = function(g) {
        ...
        g = a.extend({}, k, g);
        if (!g.flakes.length) { return this }
        if (a.wpSuperSnowCSS) { l.append('<style type="text/css">' + a.wpSuperSnowCSS + "</style>"), a.wpSuperSnowCSS = "" }
        var e = function(v, i) {
        ...
        return this.each(function() {
            p = a(this), u = "fixed";
            if (a.inArray(p[0].nodeName.toLowerCase(), ["html", "body"]) === -1) { p.css({ position: "relative", overflow: "hidden" }), u = "absolute" }
